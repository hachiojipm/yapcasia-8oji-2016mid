...
Connpassの[こちらの矢印のボタン（例）](https://gyazo.com/ad4ef16f2704de90ee1a63b8506417fb)を押して表示された、[受付表（例）](https://gyazo.com/098c9c136cf0be6bdd8596883475e86a)を印刷、あるいはスマホなどの画面にてお持ち下さい。
...
入館証は絶対に無くしたり汚損したりしないでください。は例外なく再発行できませんので外出時に無くした場合は再入館いただけず、そのままお帰りいただきます（登壇者であってもです）。
...
トークをおこなうセミナールームは昼休み以外は飲物はOKで、食事は禁止です。昼休み中はセミナールームでも飲食はOKです。ラウンジでは他人に迷惑とならない範囲であれば飲食は常時OKです。それ以外、廊下等では飲食禁止です。
